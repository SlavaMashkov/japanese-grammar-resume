...
def build():
    ...
    for n in [
        ...
        jp(
            "に and へ can both mark destinations, but に implies the final destination while へ implies direction only."
        ),
        jp(
            "Location particles に、へ、で can absorb は or も when the location becomes the topic: 図書館には？"
        ),
